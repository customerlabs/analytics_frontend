    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 top-14 z-100">
          ...
          <div
            ref={modalRef}
            className="absolute left-1/2 top-8 -translate-x-1/2 bg-white rounded-lg shadow-2xl w-full max-w-3xl max-h-[calc(100vh-8rem)] flex flex-col border border-gray-200"
            role="dialog"
            aria-modal="true"
          ...
          >
              ...
              <div className="px-6 py-3 border-b border-gray-100">
                <div className="relative" ref={orgDropdownRef}>
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 border border-blue-500 rounded text-blue-600 text-sm font-medium hover:bg-blue-50 transition-colors"
                  >
                    {selectedOrgName}
                    <ChevronDown
                      className={cn(
            ...
            <div className="flex-1 overflow-y-auto">
              {/* Table Header */}
              <div className="grid grid-cols-[1fr_80px_140px] gap-4 px-6 py-2 text-xs font-medium text-gray-500 border-b border-gray-100 sticky top-0 bg-white">
                ...
                filteredWorkspaces.map((workspace) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isSwitching}
                      className={cn(
                        "w-full grid grid-cols-[1fr_80px_140px] gap-4 px-6 py-2.5 items-center text-left hover:bg-blue-50/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <Grid3X3 className="h-4 w-4 text-gray-400 shrink-0" />
                        <span
                          className={cn(
                            "text-sm truncate",
                            isSelected
                      ...
                      <span
                        className={cn(
                          ...
                          ROLE_COLORS[workspace.role] || "text-gray-600 bg-gray-50"
                        )}
                      >
